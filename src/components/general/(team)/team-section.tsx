...
import TeamHeader from './team-section-header'
...
const members = [
    ...
    },
    {
        ...
        avatar: '/team/haseeb.jpg',
        link: '#',
    },
    {
        name: 'Hassanat Rooh Ul Amin',
        role: 'Fleet & Sales Manager',
        avatar: '/team/hasanat.jpg',
        link: '#',
    },
    {
        name: ' Muneeb Ur Rehman',
        role: 'Accountant',
        avatar: '/team/muneeb.jpg',
        link: '#',
    },
    {
        name: 'Raja Khan',
                        ...
                        {members.map((member, index) => (
                            <div
                                ...
                                <Image
                                    ...
                                    priority={index < 3} // Optional: faster loading for first few images
                                />
