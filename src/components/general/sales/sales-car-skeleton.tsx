...
/* ─────────────────────────────────────────────
   ANIMATION — FIXED: use tuple for cubic-bezier
   ───────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────
   MAIN SKELETON — DEFAULT GRID
   ───────────────────────────────────────────── */

export function SalesCarSkeleton({ count = 8 }: { count?: number }) {
  return (
    <section className="py-10 lg:py-16">
      <div className="mx-auto w-[min(1400px,92%)]">
        ...
        <div className="mb-10 text-center space-y-3">
          ...
          <Skeleton className="mx-auto h-5 w-[28rem] rounded-lg" />
        </div>
