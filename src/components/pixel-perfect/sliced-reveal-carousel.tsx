...
const SLIDES = [
  ...
  { seed: "slice-04", title: "Concrete Poems", tag: "Nº 04 — Metropolis",imageUrl:"/hero/one.jpg" },
  { seed: "slice-05", title: "Quiet Hours", tag: "Nº 05 — Interior" ,imageUrl:"/hero/one.jpg"},
];
...
<div className="relative h-[85%] w-full overflow-hidden rounded-2xl bg-neutral-950">
