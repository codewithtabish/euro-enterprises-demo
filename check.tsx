...
//                   <Button
//                     size="sm"
//                     className="gap-2 rounded-full bg-white/95 text-foreground shadow-2xl backdrop-blur-xl border border-white/20 hover:bg-white px-6 py-3 text-sm font-semibold"
//                   >
//                     View Details
...
//               {/* Meta Description — THE PREMIUM TOUCH */}
//               {description && (
//                 <motion.p
//                   className="text-[12px] leading-relaxed text-muted-foreground/80 line-clamp-2"
//                   initial={{ opacity: 0.7 }}
...
//                   <GridCarCard key={car.id} car={car} index={index} />
//                 ))}
//               </AnimatePresence>
//             </motion.div>
//           )}
...
//               <AnimatePresence mode="popLayout">
//                 {filteredCars.map((car, index) => (
//                   <ListCarCard key={car.id} car={car} index={index} />
//                 ))}
//               </AnimatePresence>
//             </motion.div>
//           )}
